...
namespace UKControllerPlugin::Euroscope {
    ...
    [[nodiscard]] auto
    UserSettingAwareInterface::operator=(const UserSettingAwareInterface&) -> UserSettingAwareInterface& = default;
    [[nodiscard]] auto
    UserSettingAwareInterface::operator=(UserSettingAwareInterface&&) noexcept -> UserSettingAwareInterface& = default;
} // namespace UKControllerPlugin::Euroscope
